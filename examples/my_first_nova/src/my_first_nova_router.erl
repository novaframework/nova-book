    ...
    [
        ...
        #{
            ...
            routes => [
                ...
                {"/notes/:id", fun my_first_nova_notes_api_controller:delete/1, #{
                    methods => [delete]
                }},
                ...
                {"/products/:id", fun my_first_nova_products_controller:update/1, #{
                    methods => [put]
                }},
                {"/products/:id", fun my_first_nova_products_controller:delete/1, #{
                    methods => [delete]
                }}
            ]
        }
